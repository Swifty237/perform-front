...
import { FightersAndTkdownRElement, SelectedLabelElement } from 'src/app/common/elements-types/ranking-element';
import { RankingService } from 'src/app/common/services/node-backend/ranking/ranking.service';

@Component({
  selector: 'app-takedown-ratio',
  templateUrl: './takedown-ratio.component.html',
  styleUrls: ['./takedown-ratio.component.scss']
})

export class TakedownRatioComponent {
  ...
  menFights: FightersAndTkdownRElement[] = [];
  womenFights: FightersAndTkdownRElement[] = [];

  displayedColumns: string[] = ['rank', 'name', 'stat'];
  dataSource = new MatTableDataSource<FightersAndTkdownRElement>();
        ...
        this._rankingService.getRankingTakedownRatio$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndTkdownRElement>(this.menFights);
        ...
        this._rankingService.getRankingTakedownRatio$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndTkdownRElement>(this.womenFights);
              this.dataSource.paginator = this.paginator;
            })
      }
    })
