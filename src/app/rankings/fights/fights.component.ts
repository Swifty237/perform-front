...
import { FightersAndFightsElement, SelectedLabelElement } from 'src/app/common/elements-types/ranking-element';
...
export class FightsComponent implements OnChanges {
  ...
  dataSource = new MatTableDataSource<FightersAndFightsElement>();
        ...
        this._rankingService.getRankingsNumberFights$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndFightsElement>(this.menFights);
        ...
        this._rankingService.getRankingsNumberFights$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndFightsElement>(this.womenFights);
              this.dataSource.paginator = this.paginator;
            })
      }
    })
