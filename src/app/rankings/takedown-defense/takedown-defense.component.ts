...
import { FightersAndTkdownDElement, SelectedLabelElement } from 'src/app/common/elements-types/ranking-element';
import { RankingService } from 'src/app/common/services/node-backend/ranking/ranking.service';

@Component({
  selector: 'app-takedown-defense',
  templateUrl: './takedown-defense.component.html',
  styleUrls: ['./takedown-defense.component.scss']
})
export class TakedownDefenseComponent {
  ...
  menFights: FightersAndTkdownDElement[] = [];
  womenFights: FightersAndTkdownDElement[] = [];

  displayedColumns: string[] = ['rank', 'name', 'stat'];
  dataSource = new MatTableDataSource<FightersAndTkdownDElement>();
        ...
        this._rankingService.getRankingsTakedownDefense$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndTkdownDElement>(this.menFights);
        ...
        this._rankingService.getRankingsTakedownDefense$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndTkdownDElement>(this.womenFights);
              this.dataSource.paginator = this.paginator;
            })
      }
    })
