...
import { FightersAndStrikesElement, SelectedLabelElement } from 'src/app/common/elements-types/ranking-element';
...
@Component({
  ...
  styleUrls: ['./strikes.component.scss']
})
export class StrikesComponent {
  ...
  menFights: FightersAndStrikesElement[] = [];
  womenFights: FightersAndStrikesElement[] = [];

  displayedColumns: string[] = ['rank', 'name', 'stat'];
  dataSource = new MatTableDataSource<FightersAndStrikesElement>();
        ...
        this._rankingService.getRankingStrikes$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndStrikesElement>(this.menFights);
        ...
        this._rankingService.getRankingStrikes$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndStrikesElement>(this.womenFights);
              this.dataSource.paginator = this.paginator;
            })
      }
    })
