...
import { FightersAndWinsElement, SelectedLabelElement } from 'src/app/common/elements-types/ranking-element';
...
export class WinsComponent {
  ...
  menFights: FightersAndWinsElement[] = [];
  womenFights: FightersAndWinsElement[] = [];

  displayedColumns: string[] = ['rank', 'name', 'stat'];
  dataSource = new MatTableDataSource<FightersAndWinsElement>();
        ...
        this._rankingService.getRankingsWins$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndWinsElement>(this.menFights);
        ...
        this._rankingService.getRankingsWins$()
          ...
          .subscribe(
            () => {
              ...
              this.dataSource = new MatTableDataSource<FightersAndWinsElement>(this.womenFights);
              this.dataSource.paginator = this.paginator;
            })
      }
    })
